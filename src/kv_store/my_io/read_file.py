...
def get_servers_list(servers: dict) -> list[tuple[str, int, int]]:
    """
    ...
    Args:
        servers: The dictionary with the server's info.
    ...
    for server_id, info in servers.items():
        servers_list.append((info["host"], int(info["kv_port"]), int(server_id)))
